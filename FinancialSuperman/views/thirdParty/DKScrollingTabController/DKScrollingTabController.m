...
- (void)setSelection:(NSArray *)selection {
    ...
    [selection enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
        ...
        UIView* lineBView = [[UIView alloc]initWithFrame:CGRectMake(0, self.buttonsScrollView.frame.size.height -2, self.buttonsScrollView.frame.size.width, 2)];
        lineBView.backgroundColor = [UIColor getColor:@"F89D40"];
        [self.buttonsScrollView addSubview:lineBView];
